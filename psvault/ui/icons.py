...
ICONS: dict[str, tuple[str, bool]] = {
    ...
    "phone": ('<path d="M6.4 3.4h3.1l1.5 3.9-2.1 1.3a12.8 12.8 0 0 0 5.9 5.9l1.3-2.1 3.9 1.5v3.1'
              'a2.1 2.1 0 0 1-2.3 2.1A17 17 0 0 1 4.3 5.7a2.1 2.1 0 0 1 2.1-2.3Z"/>', False),
    "mail": ('<rect x="2.8" y="4.6" width="18.4" height="14.8" rx="2.4"/>'
             '<path d="m3.8 7.4 7.1 5.2a2 2 0 0 0 2.2 0l7.1-5.2"/>', False),
